...
export const EventoCard = ({event}) => {
  return (
    <>
    <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
      {/* Event Header */}
      <div className="bg-primary p-4">
        <h3 className="text-xl font-bold text-white">{event.nombre}</h3>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        {/* Categories */}
        <div>
          <h4 className="text-sm font-medium text-neutral-dark mb-2">Categorías:</h4>
